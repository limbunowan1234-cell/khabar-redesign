  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: isDarkMode ? '#121212' : '#f0f2f5', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ backgroundColor: isDarkMode ? '#1e1e1e' : 'white', borderRadius: '16px', padding: '36px', boxShadow: '0 8px 32px rgba(0,0,0,0.12)', width: '100%', maxWidth: '420px', border: isDarkMode ? '1px solid #333' : 'none' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {!isLogin && (
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '6px', fontWeight: '600', fontSize: '13px', color: isDarkMode ? '#ddd' : '#333' }}>Your Home District</label>
                <select value={homeDistrict} onChange={(e) => setHomeDistrict(e.target.value)} style={{ width: '100%', padding: '12px 14px', border: '2px solid ' + (isDarkMode ? '#333' : '#eee'), borderRadius: '8px', fontSize: '15px', boxSizing: 'border-box', backgroundColor: isDarkMode ? '#2a2a2a' : '#fafafa', color: isDarkMode ? '#fff' : '#1a1a1a', outline: 'none' }}>
      ...
      <footer style={{ backgroundColor: isDarkMode ? '#1e1e1e' : '#1a1a1a', color: '#aaa', padding: '16px', textAlign: 'center', fontSize: '13px' }}>
        <p style={{ margin: 0 }}>&copy; 2026 Khabar Darjeeling. All rights reserved.</p>
      </footer>
      {showForgot && (
